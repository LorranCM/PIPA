...
<?= $this->section('content'); ?>
    ...
    <section class="hero">
        ...
        <figure id="hero-fiagure1">
            <img src=<?= base_url("assets/images/girl-holding-book.png") ?> alt="figura1">
            <canvas id="graphic-el-1"></canvas>
            <canvas id="graphic-el-2"></canvas>
        </figure>

        <figure id="hero-figure2">
            <img src=<?= base_url("assets/images/five-students-group.png") ?> alt="figura2">
        </figure>
