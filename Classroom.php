...
<body>
    ...
    <section class="page-content">
        <div id="content-selector">
            <img id="btn-documents" src="assets/icons/list-paper-school-svgrepo-com.svg" alt="Documentos">
            <img id="bnt-calendar" src="assets/icons/calendar-days-svgrepo-com.svg" alt="Calendário">
        </div>
